...
public class Bill {
	...
	/**
	 * Sorts the list of BillItems using the comparator
	 * 
	 * @param comparator the Comparator used to define the sorting order of the
	 *                   BillItems.
	 */
	public void sortBillItems(Comparator<BillItem> comparator) {
